...
class Agent(object):
    ...
    def predict_next(
        ...
        **kwargs: Any
        ...
        return processor.predict_next(sender_id, page_id)
    ...
    def execute_action(
        ...
        dispatcher = Dispatcher(sender_id,
                                ...
                                output_channel,
                                self.nlg)
        return processor.execute_action(sender_id, page_id, action, dispatcher, policy,
                                        confidence)
    ...
    def handle_text(
        ...
        page_id: Optional[Text] = UserMessage.DEFAULT_PAGE_ID
